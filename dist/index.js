...
`;class td extends tr{static{this.styles=th}setConfig(t){this._config=t}set hass(t){this._hass=t,this._discoverPlayers()}_discoverPlayers(){let t=[];for(let[e,i]of Object.entries(this._hass.states))e.startsWith("media_player.")&&t.push({id:e,name:i.attributes.friendly_name||e.replace("media_player.","")});t.sort((t,e)=>t.name.localeCompare(e.name)),this._mediaPlayers=t}render(){return D`
      <div class="form">
        <div class="row">
          <label>Name</label>
          <input
